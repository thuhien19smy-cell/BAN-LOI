  ...
  return (
    <div className="max-w-[1240px] mx-auto px-4 py-8 space-y-8">
      ...
      <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
        ...
        <div className="md:col-span-5 bg-[#23190e] border border-[#5a403c] p-6 text-center space-y-6 relative" style={{ borderRadius: 0 }}>
          ...
          <div className="space-y-1">
            ...
            <h3 className="font-headline font-bold text-xl text-[#ffe088] uppercase">
              Thành Tâm Gieo Quẻ
            </h3>
          </div>
        ...
        <div className="md:col-span-7">
          {selectedHexagram ? (
            <div
              className="bg-[#23190e] border-2 border-[#e9c349] p-6 sm:p-8 space-y-6 shadow-[0_0_35px_rgba(139,0,0,0.6)] animate-in fade-in zoom-in duration-300 relative"
              style={{
                borderRadius: 0,
                backgroundImage:
            ...
            >
              ...
              {/* Hexagram Header */}
              <div className="flex items-start justify-between border-b border-[#5a403c] pb-4">
                <div>
