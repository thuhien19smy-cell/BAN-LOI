  ...
  return (
    <div className="max-w-[1240px] mx-auto px-4 py-8 space-y-8">
      ...
      <div className="flex justify-center">
        <div className="inline-flex border border-[#5a403c] bg-[#140d04] p-1">
          <button
            onClick={() => setActiveTab('timeline')}
            className={`px-4 sm:px-6 py-2 text-xs sm:text-sm font-headline font-bold uppercase tracking-wider transition-all flex items-center gap-2 ${
              activeTab === 'timeline'
          ...
          >
            <Clock size={14} />
            <span>Thời Khắc Vận Chuyển</span>
          </button>
      ...
      {activeTab === 'timeline' && (
        <div className="max-w-4xl mx-auto space-y-6">
          {RITUAL_TIMELINE.map((event, idx) => (
            <div
              key={idx}
              className="relative bg-[#23190e] border border-[#5a403c] p-6 transition-all hover:border-[#e9c349] group"
              style={{
                borderRadius: 0,
                backgroundImage:
