    ...
    <div className="max-w-[1240px] mx-auto px-4 py-8 space-y-8">
      ...
      <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-4 pt-2">
        <button
          ...
          className={`px-4 py-2 text-xs sm:text-sm font-headline font-bold uppercase tracking-wider border transition-all ${
            selectedRealm === 'all'
              ? 'btn-primary-sharp'
        ...
        <button
          ...
          className={`px-4 py-2 text-xs sm:text-sm font-headline font-bold uppercase tracking-wider border transition-all flex items-center gap-1.5 ${
      ...
      {selectedDish && (
        <div className="fixed inset-0 z-50 bg-black/85 backdrop-blur-sm flex items-center justify-center p-4">
          <div
            className="relative w-full max-w-xl bg-[#23190e] border-2 border-[#e9c349] p-6 sm:p-8 shadow-[0_0_50px_rgba(139,0,0,0.8)] animate-in fade-in zoom-in duration-200"
            style={{ borderRadius: 0 }}
          >
            {/* Close Button */}
            <button
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <h2 className="font-headline text-2xl font-bold text-[#ffe088]">
                    {selectedDish.name}
                  </h2>
              ...
              <div className="space-y-3 bg-[#191207] p-4 border border-[#5a403c]">
                ...
                <div className="grid grid-cols-2 gap-2">
                  {selectedDish.ingredients.map((ing, idx) => (
                    <div key={idx} className="flex items-center gap-1.5 text-xs text-[#e3beb8]">
                      <LotusIcon size={12} className="text-[#e9c349]" />
                      <span>{ing}</span>
                    </div>
                  ))}
                </div>
              ...
              <div className="p-4 bg-[#2d110d] border border-[#8b0000] space-y-2">
                <div className="flex items-center gap-1.5 text-xs font-headline font-bold text-[#ffdad4] uppercase">
                  <AlertTriangle size={14} className="text-[#ff907f]" />
              ...
              <div className="flex items-center justify-between pt-2">
                ...
                <button
                  onClick={() => setSelectedDish(null)}
                  className="px-6 py-2 btn-primary-sharp font-headline font-bold text-xs uppercase tracking-wider"
                >
