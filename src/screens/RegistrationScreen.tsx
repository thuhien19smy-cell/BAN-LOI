  ...
  return (
    <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12 text-[#F2EBDD]">
      ...
      <div className="text-center space-y-3">
        <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#090A0D] border border-[#C9A24A]/50 text-xs font-mono text-[#C9A24A] uppercase tracking-widest">
          <Ticket size={14} />
          <span>ĐẶT VÉ CHÍNH THỨC • SỐ LƯỢNG CÓ HẠN</span>
          <Ticket size={14} />
        </div>

        <h1 className="font-headline text-3xl sm:text-5xl font-bold text-[#F2EBDD] uppercase tracking-wide">
          BƯỚC QUA RANH GIỚI ÂM DƯƠNG
        </h1>

        <p className="max-w-2xl mx-auto font-editorial italic text-base sm:text-lg text-[#F2EBDD]/80 leading-relaxed">
          Đêm Kinh Dị Dân Gian Việt Nam — Grand Palace, 25.10.2026. Chọn hạng vé và niêm ấn tên tục để nhận Mã Linh Bài điện tử chính thức.
        </p>
      ...
      <div className={`grid grid-cols-1 ${talismanPass ? 'lg:grid-cols-12 max-w-5xl' : 'max-w-3xl'} gap-8 mx-auto`}>
        ...
        <div className={talismanPass ? 'lg:col-span-7' : 'w-full'}>
          <div
            className="bg-[#090A0D] border border-[#C9A24A]/40 p-6 sm:p-8 relative shadow-[0_0_40px_rgba(0,0,0,0.8)]"
          ...
          >
            ...
            <div className="flex items-center justify-between border-b border-[#3A080B] pb-3 mb-6">
              <h3 className="font-headline font-bold text-lg text-[#F2EBDD] uppercase flex items-center gap-2">
                <Scroll size={18} className="text-[#C9A24A]" />
                <span>KÊ KHAI DANH TÍNH QUAN KHÁCH</span>
              </h3>
              <span className="text-[10px] font-mono text-[#C9A24A]">150 – 200 KHÁCH</span>
            </div>
          ...
          <div className="lg:col-span-5">
            <div className="space-y-4 animate-in fade-in duration-300">
              ...
              >
                ...
                {/* Talisman Code Box */}
                <div className="p-3 bg-[#080808] border border-[#C9A24A] flex items-center justify-between">
                  <div>
                    <span className="text-[9px] font-mono text-[#F2EBDD]/60 block uppercase">
                      MÃ LINH BÀI XÁC THỰC
                    </span>
                    <span className="font-mono font-bold text-sm text-[#C9A24A] tracking-wider">
                      {talismanPass.code}
                    </span>
                  </div>
                  <button
                    onClick={copyTalismanCode}
                    className="p-2 border border-[#C9A24A]/40 text-[#C9A24A] hover:bg-[#C9A24A]/10 transition-colors"
                  >
                    <Copy size={16} />
                  </button>
                </div>
                ...
                <div className="p-3 bg-[#0d0708] border border-[#C9A24A]/40 text-left space-y-1.5">
                  ...
                  <div className="text-xs font-mono text-[#F2EBDD] font-bold pl-4">
                    {ORGANIZER_EMAIL}
                  </div>
                  ...
                  <div className="pt-1 pl-4">
                    <a
                      ...
                      className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-[#1a080a] border border-[#C9A24A]/50 text-[10px] font-mono text-[#C9A24A] hover:bg-[#C9A24A]/10 transition-colors"
                    >
