  ...
  return (
    <div className="space-y-0 text-[#F2EBDD]">
      ...
      >
        ...
        <div className="absolute inset-4 sm:inset-8 border border-[#C9A24A]/25 pointer-events-none" />
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center space-y-8 py-6">
          ...
          <div className="flex flex-col items-center justify-center space-y-4">
            ...
            <div className="inline-flex items-center justify-center gap-2 px-3 sm:px-4 py-1.5 bg-[#090A0D] border border-[#C9A24A]/40 text-xs sm:text-sm font-mono text-[#C9A24A] uppercase tracking-[0.12em] sm:tracking-[0.2em] shadow-[0_0_15px_rgba(201,162,74,0.1)] whitespace-nowrap max-w-full">
          ...
          <div className="space-y-4">
            <h1
              ...
              className="font-headline text-[clamp(1.75rem,7vw,5.5rem)] font-black tracking-[0.06em] sm:tracking-[0.12em] text-[#F2EBDD] uppercase leading-none py-1 drop-shadow-[0_4px_35px_rgba(90,11,16,0.75)] drop-shadow-[0_0_25px_rgba(201,162,74,0.2)] whitespace-nowrap max-w-full flex items-center justify-center"
            >
              ĐẠI TIỆC ÂM DƯƠNG
            </h1>

            <div className="flex items-center justify-center gap-3 pt-1 whitespace-nowrap">
              <div className="h-[1px] w-8 sm:w-24 bg-gradient-to-r from-transparent via-[#C9A24A] to-transparent" />
              ...
              <div className="h-[1px] w-8 sm:w-24 bg-gradient-to-l from-transparent via-[#C9A24A] to-transparent" />
            </div>

            <div className="pt-1">
              <span className="inline-flex items-center justify-center gap-2 px-3.5 py-1 bg-[#090A0D]/90 border border-[#C9A24A]/40 text-xs sm:text-sm font-mono text-[#F2EBDD]/80 tracking-widest uppercase whitespace-nowrap max-w-full">
                <span className="text-[#C9A24A] shrink-0">✦</span>
                <span className="whitespace-nowrap">25.10.2026 · 17:00 – 21:30 · GRAND PALACE SÀI GÒN</span>
                <span className="text-[#C9A24A] shrink-0">✦</span>
              </span>
            </div>
          </div>
          ...
          <div className="p-6 sm:p-8 bg-[#090A0D]/85 border border-[#3A080B] text-center space-y-4 max-w-2xl mx-auto shadow-[0_10px_35px_rgba(0,0,0,0.8)]">
            <p className="font-headline text-base sm:text-lg text-[#C9A24A] italic tracking-wide">
              "Một đêm. Một lời nguyền. Một câu chuyện chưa bao giờ được kể hết."
            </p>

            <div className="font-editorial text-base sm:text-lg text-[#F2EBDD]/90 space-y-2 leading-relaxed">
              <p>Có những câu chuyện người ta kể để giải trí.</p>
              <p className="text-[#F2EBDD] font-bold">
                Có những câu chuyện... chỉ nên nghe khi trời đã tối.
              </p>
              <p className="text-sm sm:text-base text-[#F2EBDD]/80 pt-2 font-body">
          ...
          <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-4">
            <button
              ...
              className="w-full sm:w-auto px-8 py-4 btn-primary-sharp font-headline font-bold text-xs uppercase tracking-[0.2em] flex items-center justify-center gap-2.5"
            >
              <Ticket size={16} />
            ...
            <a
              href="#timeline"
              className="w-full sm:w-auto px-6 py-4 btn-secondary-sharp font-headline font-bold text-xs uppercase tracking-[0.2em] flex items-center justify-center gap-2"
            >
              <Clock size={16} className="text-[#C9A24A]" />
              <span>HÀNH TRÌNH ĐẠI TIỆC</span>
            </a>
          </div>
        </div>
      </div>
      ...
      <section id="timeline" className="py-20 px-4 sm:px-6 lg:px-8 bg-[#080808] relative border-b border-[#C9A24A]/25">
        <div className="max-w-4xl mx-auto space-y-12">
          <div className="text-center space-y-3">
            ...
            <h2 className="font-headline text-3xl sm:text-5xl font-bold tracking-tight text-[#F2EBDD] uppercase">
              HÀNH TRÌNH CỦA ĐẠI TIỆC
            </h2>

            <p className="font-editorial italic text-base sm:text-lg text-[#F2EBDD]/70 max-w-xl mx-auto">
              Từng canh giờ dẫn lối quan khách đi sâu vào cõi mộng ảo, đối diện với những truyền thuyết cổ xưa nhất.
            </p>
          ...
          {/* Timeline Sequence */}
          <div className="relative border-l-2 border-[#C9A24A]/50 ml-4 sm:ml-32 space-y-8 sm:space-y-10 pl-6 sm:pl-10">
            {OFFICIAL_TIMELINE.map((item, index) => (
              <div key={index} className="relative group">
                ...
                <div
                  className={`absolute -left-[31px] sm:-left-[47px] top-1.5 w-3.5 h-3.5 border border-[#C9A24A] transition-all ${
                    item.isHighlight
                ...
                >
                  <div className="flex items-center justify-between gap-2 mb-1">
                    <h3 className="font-headline font-bold text-base sm:text-xl text-[#F2EBDD] uppercase tracking-wide">
                      {item.stageName}
                    </h3>
                    {item.isHighlight && (
                      <span className="text-[10px] font-mono px-2 py-0.5 bg-[#C9A24A] text-[#080808] font-bold">
                        ĐIỂM NHẤN
                      </span>
                    )}
                  </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-[#090A0D] relative border-b border-[#C9A24A]/25 film-grain select-none">
        <div className="max-w-3xl mx-auto text-center space-y-10">
          <div className="space-y-4">
            ...
            <div className="p-6 bg-[#080808] border border-[#C9A24A]/60 shadow-[0_0_30px_rgba(201,162,74,0.15)]">
              <p className="font-headline text-lg sm:text-2xl text-[#C9A24A] font-bold tracking-wide uppercase">
                "{OFFICIAL_MESSAGES.mainMessage}"
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4 pt-4 border-t border-[#3A080B]">
            ...
            <div className="space-y-3 font-editorial text-lg sm:text-2xl text-[#F2EBDD] italic max-w-2xl mx-auto leading-relaxed">
              <p className="text-[#F2EBDD] font-semibold">
                "{OFFICIAL_MESSAGES.humanitarianMeaning[0]}"
              </p>
              <p className="text-[#C9A24A] font-bold">
        ...
        <div className="max-w-[1240px] mx-auto space-y-16">
          <div className="text-center space-y-3">
            ...
            <h2 className="font-headline text-3xl sm:text-5xl font-bold tracking-tight text-[#F2EBDD] uppercase text-center leading-tight">
              ...
              <span className="block text-[#C9A24A] text-[clamp(1.15rem,3.2vw,2.25rem)] mt-1.5 sm:mt-2 font-semibold tracking-wide whitespace-nowrap">
                BƯỚC QUA RANH GIỚI ÂM DƯƠNG
              </span>
            </h2>

            <p className="font-editorial italic text-base sm:text-lg text-[#F2EBDD]/70 max-w-xl mx-auto">
              Chỉ từ 150 – 200 tấm linh bài được ấn chỉ để đảm bảo sự riêng tư và trải nghiệm nhập vai trọn vẹn nhất.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            {OFFICIAL_TICKETS.map((pkg) => (
              ...
              >
                ...
                {pkg.popular && (
                  <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 px-3 py-0.5 bg-[#C9A24A] text-[#080808] font-mono font-bold text-[10px] tracking-widest uppercase">
                ...
                <div className="pt-4 border-t border-[#3A080B]">
                  <button
                    ...
                    className={`w-full py-3.5 font-headline font-bold text-xs uppercase tracking-[0.2em] flex items-center justify-center gap-2 ${
      ...
      <section id="faq" className="py-20 px-4 sm:px-6 lg:px-8 bg-[#090A0D] relative border-b border-[#C9A24A]/25">
        <div className="max-w-3xl mx-auto space-y-10">
          <div className="text-center space-y-3">
            ...
            <p className="font-editorial italic text-base text-[#F2EBDD]/70">
              Giải đáp chi tiết về thể lệ tham dự, không gian và quy cách trang phục.
            </p>
      ...
      <section id="location-contact" className="py-20 px-4 sm:px-6 lg:px-8 bg-[#080808] relative">
        <div className="max-w-4xl mx-auto space-y-12">
          {/* VENUE CARD */}
          <div
            className="p-8 sm:p-10 bg-[#090A0D] border-2 border-[#C9A24A] space-y-6 relative shadow-[0_0_40px_rgba(0,0,0,0.9)]"
            style={{ borderRadius: 0 }}
          >
            ...
            <div className="text-center space-y-2">
              <span className="text-[10px] font-mono text-[#C9A24A] tracking-[0.25em] uppercase block">
                ĐẠI TIỆC ÂM DƯƠNG • TỌA ĐỘ TỔ CHỨC
              </span>
              <h3 className="font-headline font-bold text-3xl sm:text-4xl text-[#F2EBDD] uppercase">
                {EVENT_INFO.venue}
              </h3>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-center py-4 border-y border-[#3A080B]">
            ...
            <div className="flex justify-center pt-2">
              <a
                ...
                className="px-6 py-3.5 btn-secondary-sharp text-xs font-headline font-bold uppercase tracking-[0.2em] flex items-center gap-2 hover:border-[#C9A24A] hover:shadow-[0_0_20px_rgba(201,162,74,0.3)] transition-all"
              >
                <MapPin size={14} className="text-[#C9A24A]" />
          ...
          {/* CONTACT INFO */}
          <div className="p-8 bg-[#090A0D] border border-[#3A080B] text-center space-y-6">
            <div className="space-y-1">
              <span className="text-xs font-mono text-[#C9A24A] uppercase tracking-[0.25em]">
                CONTACT
              </span>
              <h3 className="font-headline font-bold text-xl sm:text-2xl text-[#F2EBDD] uppercase">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl mx-auto">
              {EVENT_INFO.contacts.map((contact, cIdx) => (
                <div
                  key={cIdx}
                  className="p-4 bg-[#080808] border border-[#C9A24A]/40 flex items-center justify-between"
                >
                  ...
                  <a
                    ...
                    className="flex items-center gap-1.5 px-3 py-1.5 bg-[#3A080B] border border-[#C9A24A] text-xs font-mono text-[#F2EBDD] hover:text-[#C9A24A]"
                  >
                    <Phone size={12} />
            ...
            <div className="pt-4 flex justify-center">
              <button
                onClick={() => handleOpenBooking()}
                className="px-8 py-3.5 btn-primary-sharp font-headline font-bold text-xs uppercase tracking-[0.2em] flex items-center gap-2"
              >
                <Ticket size={14} />
                <span>[ MUA VÉ NGAY ]</span>
              </button>
