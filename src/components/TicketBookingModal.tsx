...
export const TicketBookingModal: React.FC<TicketBookingModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-sm overflow-y-auto">
      <div
        className="relative w-full max-w-lg bg-[#090A0D] border-2 border-[#C9A24A] p-6 sm:p-8 text-[#F2EBDD] space-y-6 shadow-[0_0_50px_rgba(107,17,24,0.6)] my-8"
        ...
        {!isSuccess ? (
          <>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="p-3 bg-[#080808] border border-[#3A080B] text-[11px] text-[#F2EBDD]/70 space-y-1">
                ...
                <p>
                  Sự kiện diễn ra vào 25.10.2026 từ 17:00 – 21:30 tại Grand Palace (63 Mạc Đĩnh Chi, Tân Định, TP. Hồ Chí Minh). Khuyến khích trang phục Áo dài, Áo bà ba hoặc Halloween mang sắc màu Việt Nam.
                </p>
              </div>
          ...
          <div className="text-center space-y-6 pt-2 animate-in fade-in">
            ...
            <div className="p-5 bg-[#140809] border-2 border-[#C9A24A] text-left space-y-3 relative">
              ...
              {/* Code Box */}
              <div className="p-3 bg-[#080808] border border-[#C9A24A]/50 flex items-center justify-between">
                <div>
              ...
              <div className="pt-1 text-[11px] text-[#F2EBDD]/70 font-editorial italic text-center">
                Vui lòng lưu giữ mã này để xuất trình tại bàn Check-in lúc 17:00 ngày 25.10.2026 tại Grand Palace.
              </div>
            </div>

            {/* Email Dispatch Info to trangtien3107@gmail.com */}
            {createdBooking && (
              <div className="p-3.5 bg-[#0e0809] border border-[#C9A24A]/50 text-left space-y-2">
                ...
                <div className="text-xs font-mono text-[#F2EBDD] font-bold pl-5 flex items-center gap-2">
                  <span>{ORGANIZER_EMAIL}</span>
                  <span className="text-[10px] px-1.5 py-0.5 bg-[#3A080B] text-[#C9A24A] border border-[#C9A24A]/40 font-normal">
                    Tự Động Chuyển Thư
                  </span>
                </div>
                <p className="text-[11px] text-[#F2EBDD]/70 pl-5 leading-relaxed font-body">
                  Toàn bộ chi tiết đặt vé (Mã Linh Bài, Tên khách, SĐT, Số lượng vé) đã được chuyển tiếp đến hòm thư <strong>{ORGANIZER_EMAIL}</strong> để đối chiếu danh sách.
                </p>
                <div className="pt-1 pl-5">
                  <a
                    ...
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-[#1a0c0e] border border-[#C9A24A]/60 text-[11px] font-mono text-[#C9A24A] hover:bg-[#C9A24A]/15 hover:border-[#C9A24A] transition-all"
                  >
