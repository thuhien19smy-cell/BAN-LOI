    ...
    <section className="relative py-24 px-4 sm:px-6 lg:px-8 bg-[#080808] text-[#F2EBDD] overflow-hidden film-grain select-none">
      ...
      <div className="max-w-[1280px] mx-auto relative z-10 space-y-20">
        ...
        <div className="text-center space-y-4 max-w-4xl mx-auto">
          ...
          <p className="font-editorial italic text-lg sm:text-xl text-[#F2EBDD]/80 max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            <div className="flex flex-wrap sm:inline-flex justify-center bg-[#090A0D] border border-[#C9A24A]/40 p-1 max-w-full">
              <button
                onClick={() => { setFusionLevel(0); setDoorOpened(false); }}
                className={`px-2.5 sm:px-3 py-1.5 text-[11px] sm:text-xs font-mono transition-all whitespace-nowrap ${
                  fusionLevel === 0
        ...
        >
          ...
          <div
            ...
            className={`relative p-8 sm:p-12 space-y-8 transition-all duration-700 bg-gradient-to-b from-[#090A0D] via-[#3A080B]/40 to-[#071426] border-b lg:border-b-0 lg:border-r border-[#C9A24A]/20 ${
          ...
          >
            ...
            <div className="relative z-10 space-y-6">
              <div className="space-y-2">
                ...
                <h3 className="font-headline text-2xl sm:text-4xl font-bold tracking-tight text-[#F2EBDD] uppercase">
                  HALLOWEEN PHƯƠNG TÂY
                </h3>
              </div>

              {/* Sequential Storytelling Text Lines */}
              <div className="space-y-3 py-2 border-l border-[#C9A24A]/30 pl-4 font-headline text-lg sm:text-xl text-[#F2EBDD]">
                <div
              ...
              <p className="font-editorial italic text-base sm:text-lg text-[#F2EBDD]/85 leading-relaxed">
                "Halloween mang đến tinh thần tự do khám phá thế giới của những điều kỳ lạ và bí ẩn."
              </p>
            </div>
          </div>
          ...
          <div
            ...
            onMouseLeave={() => setHoveredSide(null)}
            className={`relative p-8 sm:p-12 space-y-8 transition-all duration-700 bg-gradient-to-b from-[#090A0D] via-[#221206]/60 to-[#080808] ${
          ...
          >
            ...
            <div className="relative z-10 space-y-6">
              <div className="space-y-2">
                ...
                <h3 className="font-headline text-2xl sm:text-4xl font-bold tracking-tight text-[#C9A24A] uppercase">
                  VĂN HÓA VIỆT NAM
                </h3>
              </div>

              {/* Sequential Storytelling Text Lines */}
              <div className="space-y-3 py-2 border-l border-[#C9A24A] pl-4 font-headline text-lg sm:text-xl text-[#F2EBDD]">
                <div
                  className={`transition-all duration-700 ${
                    activeStoryStep >= 1 ? 'opacity-100 translate-x-0' : 'opacity-20 translate-x-2'
                  }`}
              ...
              <p className="font-editorial italic text-base sm:text-lg text-[#F2EBDD]/85 leading-relaxed">
                "Đó là cách người Việt nhìn nhận mối liên hệ giữa con người — gia đình — cộng đồng — người đã khuất."
              </p>
            </div>
          </div>
          </div>
          ...
          <div className="relative p-8 sm:p-14 lg:p-20 bg-[#090A0D]/95 text-center space-y-12 overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl mx-auto space-y-8">
            ...
            <h3 className="font-headline text-3xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-[#F2EBDD] uppercase">
              KHI VỊ KHÁCH GẶP GIA CHỦ
            </h3>

            {/* Narrative Passage */}
            <div className="space-y-3 font-editorial text-lg sm:text-2xl text-[#F2EBDD]/90 max-w-2xl mx-auto leading-relaxed">
            ...
            <div className="pt-2">
              <button
                ...
                className="px-6 py-3 btn-secondary-sharp text-xs font-headline font-bold uppercase tracking-widest flex items-center justify-center gap-2 mx-auto"
              >
                <Eye size={14} className="text-[#C9A24A]" />
                <span>{doorOpened ? 'ĐANG MỞ CÁNH CỬA CỔ DIỆN MẠO' : 'MỞ CÁNH CỬA GIAO THOA HAI THẾ GIỚI'}</span>
              </button>
            </div>
          </div>

          {/* THE MOST ICONIC CINEMATIC STATEMENT */}
          <div className="relative z-10 pt-8 space-y-4 text-center">
            {/* Statement 1: VĂN HÓA NGOẠI NHẬP LÀ KHÁCH */}
            <div className="flex items-center justify-center w-full">
              <p className="font-headline text-[clamp(1rem,3.2vw,2rem)] text-[#F2EBDD] font-medium tracking-wide whitespace-nowrap text-center">
            ...
            <div className="flex items-center justify-center w-full">
              <h4 className="font-headline text-[clamp(1.15rem,4.6vw,3rem)] font-black text-[#C9A24A] gold-glow uppercase tracking-wider whitespace-nowrap text-center leading-tight">
