  ...
  return (
    <header className="sticky top-0 z-50 w-full select-none">
      ...
      <div className="relative bg-[#140d04] border-b-2 border-[#5a403c] shadow-[0_8px_20px_rgba(0,0,0,0.85)]">
        ...
        <div className="max-w-[1240px] mx-auto px-4 sm:px-6 py-2.5 flex items-start justify-between relative z-10">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:gap-2.5 whitespace-nowrap">
              <div className="flex items-center gap-2 whitespace-nowrap">
                <span className="font-headline text-base sm:text-lg lg:text-xl font-bold tracking-tight text-[#F2EBDD] uppercase whitespace-nowrap">
                  Đại Tiệc Âm Dương
                </span>
              </div>
              <span className="hidden sm:inline-block text-[#C9A24A]/60">·</span>
              <p className="text-[10px] sm:text-[11px] font-body text-[#C9A24A] tracking-wider uppercase whitespace-nowrap">
          ...
          <div className="flex items-center gap-2 sm:gap-3 self-start">
            ...
            <button
              ...
              className="md:hidden p-2 text-[#f0e0cc] border border-[#5a403c] bg-[#221a0e] hover:border-[#e9c349] transition-colors self-start"
              style={{ borderRadius: 0 }}
              aria-label="Mở menu"
            >
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden bg-[#1c140a] border-t border-[#5a403c] px-4 py-3 space-y-2">
            {NAV_ITEMS.map((item) => {
              const isActive = currentScreen === item.id;
              return (
                <button
                  ...
                  className={`w-full text-left px-3 py-2 border flex items-center justify-between ${
                    isActive
                      ...
                      : 'bg-[#221a0e] text-[#f0e0cc] border-[#3c3326]'
                  }`}
                  style={{ borderRadius: 0 }}
                >
                  <div>
